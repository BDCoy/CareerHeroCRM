...
export const sendEmail = async (
  ...
  try {
    ...
    // Ensure the correct structure is sent
    const payload = {
      to: emailData.to,
      subject: emailData.subject,
      body: emailData.body,
      attachments: emailData.attachments ?? [], // Ensure it's an array
      cc: emailData.cc ?? [], // Default to empty array if undefined
      bcc: emailData.bcc ?? [],
      customerId,
    };
...
export const fetchReceivedEmails = async (
  customerId?: string
